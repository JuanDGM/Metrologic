...
<html>
    <head>
        ...
        function editar(){
            ...
            $("#btnRiesgos").attr("style","width: 300px;display:block;");
            };
        ...
        function guardar(){
            ...
            $("#invasividad").removeAttr("disabled");
            $("#equipoPorTipoRiesgo").removeAttr("disabled");
            $("#btnRiesgos").attr("style","display:none");
    }
...
// FORMATO DE HOJA DE VIDA.
        ...
        <div class="page-header" id="encabezado">
                    <div style="float:left">
                        <h1 id="titulo" style="font-weight: bold;">HOJA DE VIDA DEL EQUIPO <small></small></h1>
                    </div>
...
<form method="POST" action="hojaVida.php" id="formularioAsignacionCodigo">
        ...
        while($ArraySeleccionarPerfilUsuario=mysql_fetch_array($conexionSeleccionarPerfilUsuario)){
            ...
            if($tipoDeUsuario=="Consulta"){
                ...
                ?>
                <!--<form method="POST" id="formularioImagenesEquipos" enctype="multipart/form-data">-->
                <!--<input type="file" multiple="multiple" id="archivosSeleccionados" style="margin: 5px">-->
<!--                <input type="file" id="archivosSeleccionados" name="archivo" style="margin: 5px;<?php// echo $displayBtnGuardarImagen;?>">-->
                ...
                <!--</form>-->
            <form id="formulariohv" method="POST" enctype="multipart/form-data">
                <div>
                    <span id="resp"></span>
                    <?php
                            ...
                            <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group" style="position: relative;float: left;margin-right: 30px;">
                                                    ...
                                                    <select class="form-control" name="ciudad" id="CiudadUbicacion" style="width: 200px;" disabled>
...
//                            }
                            ...
                            <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                                ...
                                <td><input type="text" id="f_manto" class="form-control" name="f_manto" value="<?php  if(isset($mantoPreventivo)){echo $mantoPreventivo;}  ?>" placeholder="" disabled></td>
                                <td>
                                    <select class="form-control" name="inicioIntervencion" id="inicioIntervencionManto" style="width: 200px;" disabled>
                                ...
                                <td><?php  if(isset($mantoPreventivo) && isset($nuevafechaManto)){echo $nuevafechaManto;} ?></td>
                                    </tr>
                                    
                                <tr>
                                <td>VERIFICACIÓN</td>
                                <td><input type="text" id="f_verificacion" class="form-control" name="f_verificacion" value="<?php  if(isset($verificacion)){echo $verificacion;}  ?>" placeholder="" disabled></td>
                                <td>
                                    <select class="form-control" name="inicioIntervencion" id="inicioIntervencionVerificacion" style="width: 200px;" disabled>
                                    <option value="Puesta en marcha" selected>Puesta en marcha</option>
                                    <option value="Cumplimiento del ciclo">Cumplimiento del ciclo</option>
                                </select>
                                </td>    
                                <td>
                                    ...
                                    <tr>   
                                <td>CALIBRACIÓN</td>
                                <td><input type="text" id="f_calibracion" class="form-control" name="f_calibracion" value="<?php  if(isset($calibracion)){echo $calibracion;}  ?>" placeholder="" disabled></td>
                                <td>
                                    <select class="form-control" name="inicioIntervencion" id="inicioIntervencionCalibracion" style="width: 200px;" disabled>
                                    <option value="Puesta en marcha" selected>Puesta en marcha</option>
                                    <option value="Cumplimiento del ciclo">Cumplimiento del ciclo</option>
                                </select>
                                </td>
                                <td>
                                    ...
                                    <tr>
                                        <td>CALIFICACIÓN</td>
                                    <td><input type="text" id="f_calificacion" class="form-control" name="f_calificacion" value="<?php  if(isset($calificacion)){echo $calificacion;}  ?>" placeholder="" disabled></td>
                                    <td>
                                        <select class="form-control" name="inicioIntervencion" style="width: 200px;" id="inicioIntervencionCalificacion" disabled>
                                    <option value="Puesta en marcha" selected>Puesta en marcha</option>
                                    <option value="Cumplimiento del ciclo">Cumplimiento del ciclo</option>
                                </select>
                                </td>
                                    ...
                                    <tr>
                                 <td>   
                                <input type="text" style="width: 230px;" id="otro_cual" class="form-control" value="<?php  if(isset($TipoOtro)){echo $TipoOtro;}  ?>" name="otro_cual" placeholder="Otro, Cual? (escriba aca)" disabled>
                                 </td>
                                 <td>
                                 
                                <input type="text" id="f_otro" class="form-control" name="f_otro" value="<?php  if(isset($FrecuenciaOtro)){echo $FrecuenciaOtro;}  ?>" disabled>
                                </td>
                                <td>
                                    <select class="form-control" name="inicioIntervencion" id="inicioIntervencionOtro" style="width: 200px;" disabled>
                                    <option value="Puesta en marcha" selected>Puesta en marcha</option>
                                    <option value="Cumplimiento del ciclo">Cumplimiento del ciclo</option>
                                </select>
                                </td> 
                        ...
                        <div id="panel2" class="panel panel-default">
                                ...
                                <div id="collapseEight" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        if(isset($codHV)){
                                            ...
                                            $codHV1=$codHV;
                                            $visualizarbtnRiesgos="width: 300px;display:none";
                                            
                                        }else{
                                            $visualizarbtnRiesgos="width: 300px;display:block";
                                            $codHV1="";
                                        }
                                        ...
                                        $querySeleccionCamposRiesgos="SELECT 
                                                                    ...
                                                                    FROM 
                                                                            riesgos_equipos 
                                                                    WHERE 
                                                                            No_HV = '$codHV1' && CONCAT(No_HV, Id) IN (
                                                                                    SELECT 
                                                                                            CONCAT(
                                                                                                    No_HV, 
                                                                                                    MAX(Id)
                                        ...
                                        <div class="form-group col-md-4 col-lg-4">
                                            ...
                                            <!--<input type="text" id="invasividad" class="form-control" id="exampleInputName2" value="<?php // if(isset($Modelo)){echo $Modelo;}  ?>" placeholder="" disabled>-->
                                            <select class="form-control" name="invasividad" id="invasividad" disabled>
                                                
                                                <option value="<?php  if(isset($Invasividad)){echo $Invasividad;}  ?>"><?php  if(isset($Invasividad)){echo $Invasividad;}  ?></option>
                                                <option value="">-- Seleccione --</option>
                                        ...
                                        <div class="form-group col-md-4 col-lg-4">
                                            ...
                                            <!--<input type="text" id="equipoPorTipoRiesgo" class="form-control" id="exampleInputName2" value="<?php // if(isset($NoSerie)){echo $NoSerie;}  ?>" placeholder="" disabled>-->
                                        <select class="form-control" name="equipoPorTipoRiesgo" id="equipoPorTipoRiesgo" disabled>
                                                
                                                <option value="<?php  if(isset($TipoRiesgo_Equipo)){echo $TipoRiesgo_Equipo;}  ?>"><?php  if(isset($TipoRiesgo_Equipo)){echo $TipoRiesgo_Equipo;}  ?></option>
                                                <option value="">-- Seleccione --</option>
                                        ...
                                        <div class="form-group col-md-4 col-lg-4">
                                            <label for="exampleInputName2" class="col-sm-3 col-md-3 col-lg-12" style="color: white;">.</label>
                                            <button type="button" class="btn btn-primary" style="<?php echo $visualizarbtnRiesgos; ?>" id="btnRiesgos">Clic para agregar riesgos</button>
                                            <div style="display: none;" id="displayAgregarRiesgos">
                                                    <table class="table table-bordered">
                                                        <tr>
                                                            <td>
                                                                <select class="form-control" style="width: 200px;" onchange="SeleccionarImagenen(this.value)" id="riesgo" name="imagenRiesgo">
                                                                    <option value="">--Seleccione riesgo--</option>
                                                                    <option value="Riesgo de atrapamiento">Riesgo de atrapamiento</option>
                                                                    <option value="Riesgo electrico">Riesgo electrico</option>
                                                                    <option value="Precaucion riesgo especifico">Precaucion riesgo especifico</option>
                                                                    <option value="Riesgo de radiaciones laser">Riesgo de radiaciones laser</option>
                                                                    <option value="Riesgo bajas temperaturas">Riesgo bajas temperaturas</option>
                                                                    <option value="Riesgo puncion">Riesgo puncion</option>
                                                                    
                                                                  </select>
                                                            </td>
                                                            <td>
                                                                <div class="row" style="width: 70px;margin: 2px;height: 60px;">
                                                                    <!--<div class="col-xs-12 col-md-4">-->
                                                                      <a href="#" class="thumbnail">
                                                                          <img id="imagenRiesgos" src="" style="width: 100%;">
                                                                      </a>
                                                                    <!--</div>-->
                                                            ...
                                                            <td style="width: 100px;">
                                                                <button type="button" name="btnGuardarRiesgo" class="btn btn-primary btn-xs" onclick="guardarRiesgo();">Agregar</button>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            </div>    
                               ...
                               <?php
                                ...
                                while($arrayRiesgosGuardados=  mysql_fetch_assoc($conexionSeleccionarRiesgosGuardados)){
                                    ...
                                    <div style="float: left;margin: 3px;width: 100px;">
                                    <div>
                                          <img src="<?php  echo $arrayRiesgosGuardados['Icono']; ?>" alt="" style="width: 100px;">
                                          <label style="text-align: center;"><?php echo $arrayRiesgosGuardados['Riesgo'];  ?></label>
                                      </div>
                                </div>    
                                <?php  
                                }
                                
                                        $queryCantRiesgosGuardados="SELECT 
                                                                        Riesgo, 
                                                                        Icono,
                                                                        COUNT(Riesgo) AS Cant_Riesgos
                                                                FROM 
                                                                        riesgos_equipos 
                                                                WHERE 
                                                                        No_HV = '$codHV1'";
                                ...
                                $conexionCantRiesgosGuardados=mysql_query($queryCantRiesgosGuardados, $con);
                                
                                while($arrayCantRiesgosGuardados=  mysql_fetch_assoc($conexionCantRiesgosGuardados)){
                                    $cant_Riesgos=$arrayCantRiesgosGuardados['Cant_Riesgos'];
                                    
                                }
                                
                                if(isset($cant_Riesgos) && $cant_Riesgos==0){
                                    $n=2;
                                }else{
                                    $n=$cant_Riesgos+1;
                                }
                                ...
                                $recuadro1="Recuadro".$consecutivo1;
                                $recuadro2="Recuadro".$consecutivo2;
                                $recuadro3="Recuadro".$consecutivo3;
                                $recuadro4="Recuadro".$consecutivo4;
                                $recuadro5="Recuadro".$consecutivo5;
                                $recuadro6="Recuadro".$consecutivo6;
                                $recuadro7="Recuadro".$consecutivo7;
                                $recuadro8="Recuadro".$consecutivo8;
                                $recuadro9="Recuadro".$consecutivo9;
                                $recuadro10="Recuadro".$consecutivo10;
                                $recuadro11="Recuadro".$consecutivo11;
                                
                                $respuestaIcono1="respuestaIcono".$consecutivo1;
                                $respuestaIcono2="respuestaIcono".$consecutivo2;
                                $respuestaIcono3="respuestaIcono".$consecutivo3;
                                $respuestaIcono4="respuestaIcono".$consecutivo4;
                                $respuestaIcono5="respuestaIcono".$consecutivo5;
                                $respuestaIcono6="respuestaIcono".$consecutivo6;
                                $respuestaIcono7="respuestaIcono".$consecutivo7;
                                $respuestaIcono8="respuestaIcono".$consecutivo8;
                                $respuestaIcono9="respuestaIcono".$consecutivo9;
                                $respuestaIcono10="respuestaIcono".$consecutivo10;
                                $respuestaIcono11="respuestaIcono".$consecutivo11;
                                
                                $respuestaNombre1="respuestaNombre".$consecutivo1;
                                $respuestaNombre2="respuestaNombre".$consecutivo2;
                                $respuestaNombre3="respuestaNombre".$consecutivo3;
                                $respuestaNombre4="respuestaNombre".$consecutivo4;
                                $respuestaNombre5="respuestaNombre".$consecutivo5;
                                $respuestaNombre6="respuestaNombre".$consecutivo6;
                                $respuestaNombre7="respuestaNombre".$consecutivo7;
                                $respuestaNombre8="respuestaNombre".$consecutivo8;
                                $respuestaNombre9="respuestaNombre".$consecutivo9;
                                $respuestaNombre10="respuestaNombre".$consecutivo10;
                                $respuestaNombre11="respuestaNombre".$consecutivo11;
                                
                                    ?>
                                        
                                <!-- Display de iconos de riesgos creados -->
                                        
                                
                                <div style="float: left;margin: 3px;width: 100px;">
                                    <div id="<?php echo $recuadro1; ?>" style="display: none;">
                                          <img id="<?php echo $respuestaIcono1; ?>" src="" alt="" style="width: 100px;">
                                          <label id="<?php echo $respuestaNombre1; ?>" style="text-align: center;"></label>
                                      </div>
                                </div> 
                                <div style="float: left;margin: 3px;width: 100px;">
                                    <div id="<?php echo $recuadro2; ?>" style="display: none;">
                                        <img id="<?php echo $respuestaIcono2; ?>" src="" alt="" style="width: 100px;">
                                        <label id="<?php echo $respuestaNombre2; ?>" style="text-align: center;"></label>
                                      </div>
                                </div>
                                <div style="float: left;margin: 3px;width: 100px;">
                                    <div id="<?php echo $recuadro3; ?>" style="display: none;">
                                        <img id="<?php echo $respuestaIcono3; ?>" src="" alt="" style="width: 100px;">
                                        <label id="<?php echo $respuestaNombre3; ?>" style="text-align: center;"></label>
                                      </div>
                                </div>
                                <div style="float: left;margin: 3px;width: 100px;">
                                    <div id="<?php echo $recuadro4; ?>" style="display: none;">
                                        <img id="<?php echo $respuestaIcono4; ?>" src="" alt="" style="width: 100px;">
                                        <label id="<?php echo $respuestaNombre4; ?>" style="text-align: center;"></label>
                                      </div>
                                </div>
                                <div style="float: left;margin: 3px;width: 100px;">
                                    <div id="<?php echo $recuadro5; ?>" style="display: none;">
                                        <img id="<?php echo $respuestaIcono5; ?>" src="" alt="" style="width: 100px;">
                                        <label id="<?php echo $respuestaNombre5; ?>" style="text-align: center;"></label>
                                      </div>
                                </div>
                                <div style="float: left;margin: 3px;width: 100px;">
                                    <div id="<?php echo $recuadro6; ?>" style="display: none;">
                                        <img id="<?php echo $respuestaIcono6; ?>" src="" alt="" style="width: 100px;">
                                        <label id="<?php echo $respuestaNombre6; ?>" style="text-align: center;"></label>
                                      </div>
                                </div>
                                <div style="float: left;margin: 3px;width: 100px;">
                                    <div id="<?php echo $recuadro7; ?>" style="display: none;">
                                        <img id="<?php echo $respuestaIcono7; ?>" src="" alt="" style="width: 100px;">
                                        <label id="<?php echo $respuestaNombre7; ?>" style="text-align: center;"></label>
                                      </div>
                                </div>
                                <div style="float: left;margin: 3px;width: 100px;">
                                    <div id="<?php echo $recuadro8; ?>" style="display: none;">
                                        <img id="<?php echo $respuestaIcono8; ?>" src="" alt="" style="width: 100px;">
                                        <label id="<?php echo $respuestaNombre8; ?>" style="text-align: center;"></label>
                                      </div>
                                </div>
                                <div style="float: left;margin: 3px;width: 100px;">
                                    <div id="<?php echo $recuadro9; ?>" style="display: none;">
                                        <img id="<?php echo $respuestaIcono9; ?>" src="" alt="" style="width: 100px;">
                                        <label id="<?php echo $respuestaNombre9; ?>" style="text-align: center;"></label>
                                      </div>
                                </div>
                                <div style="float: left;margin: 3px;width: 100px;">
                                    <div id="<?php echo $recuadro10; ?>" style="display: none;">
                                        <img id="<?php echo $respuestaIcono10; ?>" src="" alt="" style="width: 100px;">
                                        <label id="<?php echo $respuestaNombre10; ?>" style="text-align: center;"></label>
                                      </div>
                                </div>
                                <div style="float: left;margin: 3px;width: 100px;">
                                    <div id="<?php echo $recuadro11; ?>" style="display: none;">
                                        <img id="<?php echo $respuestaIcono11; ?>" src="" alt="" style="width: 100px;">
                                        <label id="<?php echo $respuestaNombre11; ?>" style="text-align: center;"></label>
                                      </div>
                                </div>
                                    
                                 <!-- Fin display de iconos de riesgos guardados  -->
