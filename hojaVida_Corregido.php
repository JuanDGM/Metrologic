            ...
            $tipoDeUsuario=$ArraySeleccionarPerfilUsuario['Tipo_Usuario'];
                    ...
                    <?php        
                        ...
                        <div id="panel3" class="panel panel-default">
                            ...
                            if(isset($fechaUltimoManto) && $fechaUltimoManto==0 || $fechaUltimoManto=="" && isset($Fecha_Marcha) && $Fecha_Marcha!="" && $Fecha_Marcha!="0000-00-00" && $DesdeMantoPreventivo="Puesta en marcha"){
                            ...
                            if(isset($FechaUltimoVerificacion) && $FechaUltimoVerificacion==0 || $FechaUltimoVerificacion=="" && isset($Fecha_Marcha) && $Fecha_Marcha!="" && $Fecha_Marcha!="0000-00-00"){
                            ...
                            if(isset($FechaUltimoCalibracion) && $FechaUltimoCalibracion==0 || $FechaUltimoCalibracion=="" && isset($Fecha_Marcha) && $Fecha_Marcha!="" && $Fecha_Marcha!="0000-00-00"){
...
//                            }
                            ...
                            if(isset($FechaUltimoOtro) && $FechaUltimoOtro==0 || $FechaUltimoOtro=="" && isset($Fecha_Marcha) && $Fecha_Marcha!="" && $Fecha_Marcha!="0000-00-00"){
                                ...
                                <div id="collapseEight" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group col-md-4 col-lg-4">
                                            ...
                                            <label for="exampleInputName2" class="col-sm-3 col-md-3 col-lg-12">MODELO</label>
                                            <input type="text" id="modelo" class="form-control" id="exampleInputName2" value="<?php  if(isset($Modelo)){echo $Modelo;}  ?>" placeholder="" disabled>
                                        </div>

                                            
                                        <div class="form-group col-md-4 col-lg-4">
                                            <label for="exampleInputName2" class="col-sm-3 col-md-3 col-lg-12">N° SERIE</label>
                                            <input type="text" id="serie" class="form-control" id="exampleInputName2" value="<?php  if(isset($NoSerie)){echo $NoSerie;}  ?>" placeholder="" disabled>
                                        </div>

                                        <div class="form-group col-md-4 col-lg-4">
                                            <label for="exampleInputName2" class="col-sm-3 col-md-3 col-lg-12">MARCA</label>
                                            <input type="text" id="marca" class="form-control" id="exampleInputEmail2" value="<?php  if(isset($Marca)){echo $Marca;}  ?>" placeholder="" disabled>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4 col-lg-4">
                                            <label for="exampleInputName2" class=" col-sm-4 col-md-3 col-lg-12">VOLTAJE</label>
                                            <input type="text" id="voltaje" class="form-control" id="exampleInputName2" value="<?php  if(isset($Voltaje)){echo $Voltaje;}  ?>" placeholder="" disabled>
                                        </div>

                                        <div class="form-group col-md-4 col-lg-4">
                                            <label for="exampleInputName2" class="col-sm-3 col-md-3 col-lg-12">AMPERAJE</label>
                                            <input type="text" id="amperaje" class="form-control" id="exampleInputName2" value="<?php  if(isset($Amperaje)){echo $Amperaje;}  ?>" placeholder="" disabled>
                                        </div>

                                        <div class="form-group col-md-4 col-lg-4">
                                            <label for="exampleInputName2" class="col-sm-3 col-md-3 col-lg-12">POTENCIA</label>
                                            <input type="text" id="potencia" class="form-control" id="exampleInputEmail2" value="<?php  if(isset($potencia)){echo $potencia;}  ?>" placeholder="" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4 col-lg-12">
                                            <label id="labelTxtArea" for="exampleInputName2" class="col-sm-3 col-md-3 col-lg-12">CARACTERISTICAS Y COMPONENTES DEL EQUIPO<br/></label>
                                            <textarea id="caracteristicas" class="form-control" rows="5" value="<?php  if(isset($caracteristicas)){echo $caracteristicas;}?>" placeholder="" disabled></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
