...
$queryIntervencionEquipo= "SELECT
        ...
        h.No_HV,
        h.Nombre_Equipo,
        MAX(r.Fecha_Intervencion) as Maxima_Fecha,
        i.Tipo_Intervencion,
        ...
        ), IF(MAX(r.Fecha_Intervencion) is NULL AND i.Aplica_Desde='Puesta en marcha',p.Fecha_Marcha,(DATE_ADD(
		MAX(r.Fecha_Intervencion), INTERVAL i.Frecuencia DAY 
        )))) AS PROXIMA_FECHA,
...
WHERE
    ...
    IF(DATEDIFF(IF(r.Fecha_Intervencion IS NOT null AND r.Fecha_Intervencion>=p.Fecha_Marcha,
        ...
        (IF(r.Fecha_Intervencion is NULL AND i.Aplica_Desde='Puesta en marcha',p.Fecha_Marcha,('2017-03-19')))),
