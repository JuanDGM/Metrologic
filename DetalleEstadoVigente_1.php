    ...
    <body id="cuerpo">
      <div id="franjaColores">
        ...
        <div id="contorno1">
            ...
            <h2><label id="Titulos">PROXIMAS INTERVENCIONES</label> <small></small></h2>
            </div>
            <br/> 
...
GROUP BY 
	...
	IF(r.Fecha_Intervencion IS null,
        DATE_ADD(
		p.Fecha_Marcha, INTERVAL i.Frecuencia DAY
	), 
        DATE_ADD(
        ...
        IF(DATEDIFF(IF(r.Fecha_Intervencion IS null,
        DATE_ADD(
		p.Fecha_Marcha, INTERVAL i.Frecuencia DAY
	), 
        DATE_ADD(
                        ...
                        <td>
                            ...
                            <td>
                                <div class="form-group">
                                 ...
                                 <input type="date" name="fechasolicitud" class="form-control" placeholder="" value="<?php echo $fecharegistro; ?>">
                               </div>
                            </td>
                            <td style="width: 20px;"></td>
                            <td>
           ...
           <script type="text/javascript">
            ...
            <table id="tablaBuscada1" class="table table-bordered table-hover" style="width: 90%;margin: auto;">
                <thead>
                   ...
                   <td>CODIGO EQUIPO</td>
                   <td>NOMBRE EQUIPO</td>
                   <td>FECHA ULTIMA INTERVENCION</td>
                   <td>TIPO INTERVENCION</td>
                   <td>FECHA PPTO EJECUTAR</td>
                   <td>VIGENCIA</td>
                   <td>PROGRAMAR</td>
